...
namespace Kepler::Type {
    ...
    llvm::Type* Int32Type::get_llvm_type() const {
        return llvm::Type::getInt32Ty(Compiler::get().get_context());
    }

    llvm::Value* Int32Type::cast(llvm::Value* value, TypeToken to) const {
        switch (to) {
            case TypeToken::Bool: return Compiler::get().get_builder().CreateICmpNE(value, llvm::ConstantInt::get(get_by_token(TypeToken::Int32), 0));
            case TypeToken::Char:
